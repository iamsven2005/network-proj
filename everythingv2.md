...
ip route 172.16.1.192 255.255.255.248 172.16.1.184
...
interface g0/0/1
 ip address 172.16.1.187 255.255.255.252
 ip nat inside
 no shutdown

interface g0/0/0
 ip address 172.16.1.189 255.255.255.252
 ip nat inside
 no shutdown
...
! Routes to internal server subnet through both core switches
ip route 172.16.1.192 255.255.255.248 172.16.1.186
ip route 172.16.1.192 255.255.255.248 172.16.1.188
